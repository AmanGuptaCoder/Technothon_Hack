                ...
                <div class="dashboard-main-card">
                    ...
                    <div id="doctor-details">
                        <div style="display:flex"> 
                            <div style="color:#6592e6;font-weight:500;margin-right:10px; font-size:1.2rem;">Doctor Name: </div>
                            <div style="font-size:1.2rem;"> Dr. Shushmita Agrawal</div>
                        </div>
                        <div style="display:flex">
                            <div style="color:#6592e6;font-weight:500;margin-right:10px; font-size:1.2rem;">Hospital Name: </div>
                            <div style="font-size:1.2rem;"> Ram Narayan Hospital, G.E. Road, Raipur</div>
                        </div>
                    </div>
                    <?php
                    $query = "SELECT * FROM prescription WHERE patientId='$pid'";
                    ...
                    if($res){
                        while($row=$res->fetch_array()){
                            ...
                            <div>
                            <h2 style='color:#6592e6'>$title</h2>
                            </div>
                            $prescription
                             </div>
                            ";
   ...
   <section class="footer3 cid-s48P1Icc8J" once="footers" id="footer3-i"><div class="container">
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row row-copirayt">
                <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">Made With ❤️ by Team C.O.D.E&nbsp;</p>
            </div>
        </div>
    </div>
</section>
